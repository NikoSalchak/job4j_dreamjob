...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestCertainVacancyByIdThenGetThatVacancy() {
        var vacancy = Optional.of(new Vacancy(1, "test1", "desc1", now(), true, 1, 2));
        when(vacancyService.findById(anyInt())).thenReturn(vacancy);
        var model = new ConcurrentModel();
    ...
    @Test
    public void whenPostRequestToUpdateCertainVacancyThenRedirectToVacancies() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenDeleteRequestByIdThenRedirectToVacancies() {
    ...
    @Test
    public void whenDeleteRequestByIdThenGetErrorPageWithMessage() {
